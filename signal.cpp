...
int main() {
  ...
  if (!alice.dratchet.decryptMessage(bobCiphertext, bobCiphertextLen, bobNonce,
                                     decryptedFromBob, decryptedFromBobLen)) {
